...
/*   Updated: 2021/08/03 21:47:09 by dokkim           ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
void	move_right(t_data *data)
{
	...
	if (flag == 0)
	{
		data->images.player = mlx_xpm_file_to_image(data->images.mlx, "./srcs/images/dao_right1.xpm", &(data->images.width), &(data->images.height));
		flag = 1;
	}
	else
	{
		data->images.player = mlx_xpm_file_to_image(data->images.mlx, "./srcs/images/dao_right2.xpm", &(data->images.width), &(data->images.height));
		flag = 0;		
	}
